...
| A5 | محوّل Telegram (وضع اختبار، بلا إرسال حيّ) | ⏳ التالي |
| A6 | أول تجربة — Daily Operations Brief (قراءة فقط) | ⏳ |

**نهاية A:** دماغ يعمل محليًا، tenant-aware، قابل للاختبار — بلا لمس أي شيء حقيقي.
